    ...
    HighestDensityViewController.prototype = {
        ...
        prepareRows: function ( data )
        {
            ...
            $.each(data, function ( index, row ) {
                ...
                /* Jacksonburg's population is too small for quickfacts,
                 * so the link will simply go to Popclock.
                 */
                if(row.name == 'Jacksonburg village, OH') {
                   rows[index] = [
                       //'<a href="">' + row.name + '</a>',
                       '<p style="color: #008392; padding: 5px; text-decoration: underline;">Jacksonburg village, OH</p>',
