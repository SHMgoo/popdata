  ...
  >
    <section class="population-counter" :class="sizeClass">
      ...
      <div class="counter-shell">
        ...
        <div v-if="props.showProgress" class="progress-wrap">
...
const progress01 = computed(() => {
  ...
  return Math.max(0, Math.min(1, populationFraction.value))
})

const progressPercent = computed(() => progress01.value * 100)
