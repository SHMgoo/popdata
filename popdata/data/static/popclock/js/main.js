...
var _URL_ = '//' + window.location.hostname + window.location.pathname.replace(/\/[^\/]*$/, '/');
...
var floatToPercentString = function(a_float, decimalPlaces)
{
	var rawPercent = a_float * 100;		
	var multiplier = 1;
	var zeros = '';
...
var intPercentString = function(a_int, decimalPlaces)
{
	return floatToPercentString(a_int/100, decimalPlaces);
}
